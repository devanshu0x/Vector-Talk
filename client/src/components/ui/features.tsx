...
export function Features(){
    return <section className="pt-8 pb-18">
        ...
        <div className="grid sm:grid-cols-3 mt-12 max-w-240 mx-auto gap-10 sm:gap-16">
            <div className="sm:col-span-2 border-2 border-primary/70 px-4 py-3 rounded-sm shadow-sm shadow-primary/50 hover:rotate-2 transition-transform duration-300">
            ...
            <div className="sm:col-span-2 sm:col-start-2 border-2 border-primary/70 px-4 py-4 rounded-sm shadow-sm shadow-primary/50 hover:-rotate-2 transition-transform duration-300">
            ...
            <div className="sm:col-span-2 sm:col-start-2 border-2 border-primary/70 px-4 py-3 rounded-sm shadow-sm shadow-primary/50 hover:-rotate-2 transition-transform duration-300">
